...
func TestSolutions(t *testing.T) {
	...
	blankR1 := rdf.NewBlankNode("r1")
	iriAlice := rdf.NewNamedNode("http://work.example.org/alice/")
	litAlice := rdf.NewStrLiteral("Alice")
	litBob := rdf.NewLangLiteral("Bob", "en")
	xsdInteger := rdf.NewNamedNode("http://www.w3.org/2001/XMLSchema#integer")
	xsdFloat := rdf.NewNamedNode("http://www.w3.org/2001/XMLSchema#float")
	xsdBoolean := rdf.NewNamedNode("http://www.w3.org/2001/XMLSchema#boolean")
	xsdDateTime := rdf.NewNamedNode("http://www.w3.org/2001/XMLSchema#dateTime")
